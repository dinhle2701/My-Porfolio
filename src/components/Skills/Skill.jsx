                            ...
                            <div key={index} className="bg-white rounded-3xl text-center w-[350px] shadow-md flex flex-col mb-2">
                                ...
                                <div className="p-4 flex flex-col flex-grow">
                                    ...
                                    <div className="mt-auto">
                                        <button className="bg-blue-400 text-white py-2 px-4 rounded-3xl hover:bg-blue-600 hover:cursor-pointer transition duration-300 ease-in-out hover:scale-105">
                                            Learn More
                                        </button>
                                    </div>
                                </div>
