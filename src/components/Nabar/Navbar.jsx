    ...
    <div className="navbar py-4 bg-gray-400 shadow-xl fixed top-0 w-full z-50">
      <Container>
        <div className="flex justify-between items-center">
          <h1 className="font-serif text-amber-800 text-3xl transform transition duration-300 ease-in-out hover:scale-140">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            {navLinks.map((link, index) => (
              <span key={index} className="text-sm text-black inline-block min-w-[90px] text-center 
